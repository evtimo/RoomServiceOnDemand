...
public class SignUpEmailCorrectnessTest {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][]{{"password1", "name1", "email1@mail.ru", "89991112233"},
				{"password1", "name2", "email2@mail.ru", "89991112233"},
				{"password1", "name3", "email3@mail.ru","89991112233"}};
	...
	@Test
	public void Should_NotSignUp_When_EmailIsNotInternationalFormat() {
		User user = new User();
