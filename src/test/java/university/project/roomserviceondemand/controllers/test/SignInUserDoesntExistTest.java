...
public class SignInUserDoesntExistTest {
	...
	public static Collection<Object[]> data() {
		Object[][] data = new Object[][]{{"12345678", "email_not_exist@mail.ru"}};
	...
	@Test
	public void ShouldNotSignIn_SignIn_When_UserDoesNotExist() {
		...
		assertEquals("Account for the provided email was not found!", authorizationController.signIn(user));
	}
}